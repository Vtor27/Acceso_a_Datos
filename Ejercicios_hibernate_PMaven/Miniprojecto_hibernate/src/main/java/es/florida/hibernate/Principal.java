	...
	public static void main(String[] args) {
		...
		do {
			...
			case 4:
				...
				editarLibro(idLibroEdit);
				break;
				
			case 5:
				System.out.println("Indica el id ddel libro que quieres eliminar -> ");
				int idLibroDelete = scanner.nextInt();
				eliminarLibroPorId(idLibroDelete);
				break;
